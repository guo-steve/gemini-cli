...
import { Content, createUserContent, GenerateContentConfig, GenerateContentResponse, Part, SendMessageParameters, Tool } from '@google/genai';
...
/**
 * Chat session that enables sending messages to the Deepseek model with previous
        ...
        return this.contentGenerator.generateContent(
          {
            ...
            config: { ...this.generationConfig, ...params.config } as any,
          },
          prompt_id,
        );
      };
